...
const forgotPasswordToken = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    await user.save();
    const resetURL = `Hi, Please follow this link to reset Your Password. This link is valid till 10 minutes from now. <a href='http://localhost:5000/resetpassword/${token}'>Click Here</>`;
    const data = {
      to: email,
      text: "Hey User",
...
const updateProductQualityFromCart = asyncHandler(async (req, res) => {
  const { _id } = req.user;
